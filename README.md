...
> been proposed upstream. Unsigned test builds are available on the
> [releases page](https://github.com/iblackscreen/arduino-ide/releases). All changes are documented
> in the commit history (July 2026). This fork is not affiliated with or endorsed by Arduino.
